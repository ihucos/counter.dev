        ...
        draw(user, sessionless) {
            ...
            if (sessionless){
                this.innerHTML = `
                    ...
                    <span class="gray ml8 mr16">You are viewing ${escapeHtml(user.id)}'s dashboard as guest</span>
                ...
                this.getElementsByTagName('a')[1].onclick = ()=>this.post('/deletetoken')
            } else {
                this.innerHTML = `
                    <img
                ...
                this.getElementsByTagName('a')[0].onclick = ()=>this.post('/resettoken')
            }
        }
