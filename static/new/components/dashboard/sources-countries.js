        ...
        drawItemCountries(countryCode, count) {
          ...
          <div class="sources-countries-item shadow-sm mb8">
            <div class="percent-line" style="width: ${escapeHtml(
                percentRepr(count, this.totalCount)
            )};"></div>
            <div class="sources-countries-item-wrap">
              <span>
            ...
            this.innerHTML = `
                <div class="content radius-lg responsive-tabs">
                  ...
                  <div class="sources" id="sources">
                    ...
                    ${allSourcesEntries.length > this.sourcesEntriesCount ? this.drawViewAll() : ""}
                  </div>
                  <!-- Countries -->
                  <div class="countries" id="countries">
                    ...
                    <!-- Item -->
                    <div class="sources-countries-item shadow-sm mb8">
                      <div class="percent-line" style="width: 10%"></div>
                      <div class="sources-countries-item-wrap">
                        <span>
                          <img
                            src="img-delete/canada.png"
                            width="16"
                            height="11"
                            alt="Canada"
                          />
                        ...
                        <span>
                          <span class="strong mr16">18</span>
                          <span class="item-percent bg-blue blue caption">10%</span>
                        </span>
                      </div>
                    </div>
                    <!-- View all -->
