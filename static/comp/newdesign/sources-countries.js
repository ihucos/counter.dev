customElements.define(
    ...
    class extends HTMLElement {
        maxEntries = 10
        draw(objData) {
            var allEntries = Object.entries(objData).sort((a, b) => b[1] - a[1])
        ...
        drawItemSources(domain, count) {
            return `
          <div class="sources-countries-item shadow-sm mb8">
            <div class="percent-line" style="width: ${percentRepr(count, this.totalCount)};"></div>
            <div class="sources-countries-item-wrap">
              <span>
                <img
                  src="https://icons.duckduckgo.com/ip3/${escapeHtml(domain)}.ico"
                  width="16"
                  height="16"
                  alt="${escapeHtml(domain)}">
                <a href="//${escapeHtml(domain)}" class="black" target="_blank" rel="nofollow">
                ${escapeHtml(domain)}
                </a>
              </span>
              <span>
        ...
        drawItemCountries(countryCode, count) {
            return `
          <div class="sources-countries-item shadow-sm mb8">
