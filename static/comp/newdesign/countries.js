customElements.define(
    ...
    class extends HTMLElement {
        draw(ref) {
            var allCountryEntries = Object.entries(ref).sort((a, b) => b[1] - a[1])
            var countryEntries = allCountryEntries.slice(0, 10);
        ...
        <div class="countries" id="countries">
          ...
          <!-- Items -->
          ${countryEntries.map((item) => this.drawItem(item[0], item[1])).join('')}
          <!-- View all -->
          <a href="#modal-countries" class="sources-countries-item sources-countries-item-wrap view-all shadow-sm" rel="modal:open">
            <span>
        ...
        ${this.drawModal(allCountryEntries)}`
        }
        ...
        drawModal(countryEntries) {
            return `<div id="modal-countries" style="display: none;">
