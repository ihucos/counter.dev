    ...
    class extends HTMLElement {
        ...
        draw(dates) {
            ...
            if (vals.length === 0){
                ...
                this.innerHTML = this.getTrend(this.STABILITY, null, "Not enough data to determine trend")
                return
            } else {
                ...
                if (percent > 10) {
                    this.innerHTML = this.getTrend(this.POSITIVE, percent, title)
                    return
                } else if (percent < -10) {
                    this.innerHTML = this.getTrend(this.NEGATIVE, percent, title)
                    return
                } else {
                    this.innerHTML = this.getTrend(this.STABILITY, null, title)
                    return
                ...
                return `
                   <div class="graph-dynamics">
                     ...
                     <div class="graph-dynamics-content gradient-green radius-lg">
                       <div class="dynamics positive caption" title="${escapeHtml(title)}">${escapeHtml(percentAbs)}%</div>
                ...
                return `
                   <div class="graph-dynamics">
                     ...
                     <div class="graph-dynamics-content gradient-red radius-lg">
                       <div class="dynamics negative caption" title="${escapeHtml(title)}">${escapeHtml(percentAbs)}%</div>
                ...
                return `
                   <div class="graph-dynamics">
                     ...
                     <div class="graph-dynamics-content bg-gray radius-lg">
                       <div class="dynamics stability caption" title="${escapeHtml(title)}"></div>
