...
connectData("comp-newdesign-pie#platforms comp-newdesign-piegraph", k("platform"));
connectData("comp-newdesign-pie#browsers comp-newdesign-piegraph", k("browser"));

connectData("comp-newdesign-pie#devices comp-newdesign-pielegend", k("device"));
connectData("comp-newdesign-pie#platforms comp-newdesign-pielegend", k("platform"));
connectData("comp-newdesign-pie#browsers comp-newdesign-pielegend", k("browser"));
