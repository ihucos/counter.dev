...
function register() {
    ...
    postUserAction(
        ...
        (errMsg) => {
            ...
            document.getElementById("alert_register").innerHTML = escapeHtml(
                errMsg
            );
        }
    );
...
function login() {
    ...
    postUserAction(
        ...
        (errMsg) => {
            ...
            document.getElementById("alert_login").innerHTML = escapeHtml(
                errMsg
            );
        }
    );
...
function pageOn(name) {
    ...
    document.querySelector('section[id="' + name + '"]').style.display =
        "block";
}
